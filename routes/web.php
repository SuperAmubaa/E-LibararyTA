...
Route::prefix('/')->group(function () {
    ...
    Route::prefix('filter')->group(function () {
        Route::get('/{filter}/{name}', [HomeController::class, 'filter'])->name('homeFilter');
        Route::get('/{filter}/{name}/page/{page}', [HomeController::class, 'filter'])->name('homeFilterPage');
    });
    ...
    Route::middleware('isLogin')->prefix('profile')->group(function () {
        Route::put('/{id}' ,[ProfileController::class, 'update'])->name('Profile');
        Route::get('/modal/{get}/{id}', [ModalContentController::class, 'profile'])->name('modalProfile');
        Route::put('/password/{id}', [ProfileController::class, 'changePassword'])->name('changePassword');
    });
...
Route::middleware('isPetugas')->prefix('petugas')->group(function () {
    ...
    Route::prefix('pengarang')->group(function () {
        ...
        Route::put('/{id}', [PengarangController::class, 'update'])->name('updatePengarang');
    ...
    Route::prefix('jenisDenda')->group(function () {
        ...
        Route::put('/{id}', [JenisDendaController::class, 'update'])->name('updateJenisDenda');
        // Route::delete('/{id}', [PengarangController::class, 'destroy'])->name('destroyPenerbit');
    });
