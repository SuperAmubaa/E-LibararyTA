...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        return view('admin.home', compact('ar_role','jml','ar_status','ar_status1','user_jan','user_feb','user_mar','user_apr','user_mei','user_jun','user_jul','user_agus','user_sep','user_okt','user_nov','user_des'));
