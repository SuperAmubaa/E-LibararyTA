...
<div class="sidebar-menu">
    <ul class="menu" style="margin-top: -5px">
        ...
        <li class="sidebar-item has-sub {{ $page == 'petugasPeminjaman' || $page == 'petugasPengembalian' ? 'active' : '' }}">
            <a href="#" class='sidebar-link'>
                <i class="fas fa-chart-area"></i>
                <span>Transaksi</span>
            </a>
            <ul class="submenu {{ $page == 'petugasPeminjaman' || $page == 'petugasPengembalian' ? 'active' : '' }}">
                <li class="submenu-item {{ $page == 'petugasPeminjaman' ? 'active' : '' }}">
                    <a href="{{ route('petugasPeminjaman') }}">Peminjaman</a>
                </li>
                <li class="submenu-item {{ $page == 'petugasPengembalian' ? 'active' : '' }}">
